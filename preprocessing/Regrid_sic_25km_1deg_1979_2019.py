...
#****** read original data
diri='/mothership/yhuang/Data/SSM_sea_ice_daily_original/'
file0 = diri+'Passive_sea_ice_concentration_daily_25km_1979_2019.nc'
...
dd2=np.array(data.variables['sic'][:][:][:])
...
plt.pcolormesh(lon1,lat1,dd2[8,:,:]);
...
plt.savefig('tes2_after_Jan.png')
...
plt.savefig('tes2_after_Sept.png')

#******  write to nc file
### save data and write it to nc file ###
ncfile=Dataset(diri+'Passive_sea_ice_concentration_daily_1deg_1979_2019.nc',mode='w',format='NETCDF4')
